Attribute VB_Name = "HID_USB_Module"
...
' set to..
'
' mainmdi.OnPlugged(ByVal pHandle as long)
' mainmdi.OnUnplugged(ByVal pHandle as long)
' mainmdi.OnChanged()
' mainmdi.OnRead(ByVal pHandle as long)
